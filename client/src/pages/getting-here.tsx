    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-64 bg-gradient-to-r from-sea-blue to-tropical-aqua">
        <div 
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1436491865332-7a61a109cc05?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1920&h=1080')`,
