...
import { ArrowLeft, Calendar, User, MapPin, Home, Compass, BookOpen, Plane, Info, Phone } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 ml-16 flex">
          ...
          {/* This section is now handled by SidebarNavigation component */}
