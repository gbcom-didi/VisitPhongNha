          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="lg:order-first">
              <div 
                ...
                style={{
                  backgroundImage: `url('https://images.unsplash.com/photo-1544551763-46a013bb70d5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=800')`
                }}
              />
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              These principles guide everything we do at ĐiĐiVui
            </p>
          </div>
