...
export const getCategoryIconPath = (categorySlug: string): string => {
  const iconPaths: Record<string, string> = {
    ...
    'kiting': 'M12 2l-6 8 6 8 6-8-6-8zm0 3l3 5-3 5-3-5 3-5z', // Diamond kite shape
    ...
    'supermarket': 'M7 4V2a1 1 0 011-1h8a1 1 0 011 1v2h5a1 1 0 011 1v2a1 1 0 01-.78.97L21 9l-1 7a1 1 0 01-1 1H5a1 1 0 01-1-1L3 9l-1.22-1.03A1 1 0 011 7V5a1 1 0 011-1h5zM9 3v1h6V3H9zm10 4H5l.8 6h12.4L19 7z', // Shopping cart/store icon
