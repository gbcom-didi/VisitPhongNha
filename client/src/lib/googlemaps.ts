...
export const getCategoryIconPath = (categorySlug: string): string => {
  const iconPaths: Record<string, string> = {
    ...
    'kiting': 'M3 6c1 0 2-1 3-1s2 1 3 1 2-1 3-1 2 1 3 1 2-1 3-1 2 1 3 1v2c-1 0-2 1-3 1s-2-1-3-1-2 1-3 1-2-1-3-1-2 1-3 1-2-1-3-1V6zM4 10c2 0 4-1 6-1s4 1 6 1 4-1 6-1v2c-2 0-4 1-6 1s-4-1-6-1-4 1-6 1v-2zM5 14c1.5 0 3-.5 4.5-.5s3 .5 4.5 .5 3-.5 4.5-.5v2c-1.5 0-3 .5-4.5 .5s-3-.5-4.5-.5-3 .5-4.5 .5v-2z', // Wind flow lines
    'surf': 'M4 14c2.2-2.2 5.8-2.2 8 0 2.2-2.2 5.8-2.2 8 0M3 20.5c3.3-3.3 8.7-3.3 12 0 3.3-3.3 8.7-3.3 12 0M2 8.5c4.4-4.4 11.6-4.4 16 0 4.4-4.4 11.6-4.4 16 0', // Wave patterns
    ...
    'recreation': 'M13.5 5.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zM9.8 8.5L12 7.3c.4-.2.8-.3 1.2-.3.7 0 1.4.2 2 .7l2.7 2.7c.4.4.4 1 0 1.4-.4.4-1 .4-1.4 0L15.3 10c-.5-.5-1.2-.8-1.9-.8-.4 0-.8.1-1.2.3L9.8 11v5.5c0 .6-.4 1-1 1s-1-.4-1-1V10c0-.6.4-1 1-1s1 .4 1 1v-.5z', // Active person
