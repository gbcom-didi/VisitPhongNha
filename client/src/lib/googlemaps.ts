...
export const getCategoryIconPath = (categorySlug: string): string => {
  const iconPaths: Record<string, string> = {
    ...
    'kiting': 'M12 2l2 4 4-2-2 4 4 2-4 2 2 4-4-2-2 4-2-4-4 2 2-4-4-2 4-2-2-4 4 2z', // Kite shape
    'surf': 'M12 2C8.7 2 6 4.7 6 8c0 .8.2 1.5.4 2.2C5.2 11.4 4 13 4 15c0 2.8 2.2 5 5 5h6c2.8 0 5-2.2 5-5 0-2-1.2-3.6-2.4-4.8.2-.7.4-1.4.4-2.2 0-3.3-2.7-6-6-6zm0 16c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z', // Surfboard shape
    ...
    'recreation': 'M12 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm4 18H8c-.6 0-1-.4-1-1s.4-1 1-1h.5c.3-.6.9-1 1.5-1h4c.6 0 1.2.4 1.5 1H16c.6 0 1 .4 1 1s-.4 1-1 1zm-3-6c0 1.1-.9 2-2 2s-2-.9-2-2c0-.8.5-1.5 1.3-1.8L8 8c-.6-.6-.6-1.4 0-2s1.4-.6 2 0l2 2 2-2c.6-.6 1.4-.6 2 0s.6 1.4 0 2l-2.3 4.2c.8.3 1.3 1 1.3 1.8z', // Swimming/beach person
