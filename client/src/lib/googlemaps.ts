...
export const getCategoryIconPath = (categorySlug: string): string => {
  const iconPaths: Record<string, string> = {
    ...
    'street-food': 'M2 12h20l-2 8H4l-2-8zm2-2V8c0-2.21 1.79-4 4-4h8c2.21 0 4 1.79 4 4v2H4zm14-6c0-.55-.45-1-1-1H7c-.55 0-1 .45-1 1s.45 1 1 1h10c.55 0 1-.45 1-1z', // Simple food cart/stand
