...
export const getCategoryIconPath = (categorySlug: string): string => {
  const iconPaths: Record<string, string> = {
    ...
    'street-food': 'M12 2C8 2 5 5 5 9v6c0 2.5 2 4.5 4.5 4.5h5C17 19.5 19 17.5 19 15V9c0-4-3-7-7-7zm0 2c3 0 5 2 5 5v6c0 1.5-1 2.5-2.5 2.5h-5C8 17.5 7 16.5 7 15V9c0-3 2-5 5-5z', // Simple bowl
