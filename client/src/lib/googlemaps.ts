...
export const getCategoryIconPath = (categorySlug: string): string => {
  const iconPaths: Record<string, string> = {
    ...
    'kiting': 'M12 2c1.1 0 2 .9 2 2 0 .5-.2 1-.5 1.3L16 8l2 1-2 1 2 2-2-1-2.5 2.7c.3.3.5.8.5 1.3 0 1.1-.9 2-2 2s-2-.9-2-2c0-.5.2-1 .5-1.3L8 11l-2 1 2-1-2-2 2 1 2.5-2.7C10.2 7 10 6.5 10 6c0-1.1.9-2 2-2zm-6 16c-.6 0-1-.4-1-1s.4-1 1-1h12c.6 0 1 .4 1 1s-.4 1-1 1H6z', // Kitesurfer on water
    'surf': 'M2 12c0-.6.4-1 1-1h2c1.7 0 3-1.3 3-3s-1.3-3-3-3H3c-.6 0-1-.4-1-1s.4-1 1-1h2c2.8 0 5 2.2 5 5s-2.2 5-5 5H3c-.6 0-1-.4-1-1zm8 0c0-.6.4-1 1-1h2c1.7 0 3-1.3 3-3s-1.3-3-3-3h-2c-.6 0-1-.4-1-1s.4-1 1-1h2c2.8 0 5 2.2 5 5s-2.2 5-5 5h-2c-.6 0-1-.4-1-1zm-8 6c0-.6.4-1 1-1h2c1.7 0 3-1.3 3-3s-1.3-3-3-3H3c-.6 0-1-.4-1-1s.4-1 1-1h2c2.8 0 5 2.2 5 5s-2.2 5-5 5H3c-.6 0-1-.4-1-1z', // Wave pattern
    ...
    'recreation': 'M12 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm-1 4h2l1 7h-1l-1-5-1 5H9l1-7zm-2 8h6v1c0 .6-.4 1-1 1h-4c-.6 0-1-.4-1-1v-1zm1 4h4v6h-1v-4h-2v4H10v-6zm6-8l2 2v8h-2v-6l-2-2v-2z', // Hiking figure with backpack and walking stick
