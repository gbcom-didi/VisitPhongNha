...
export const getCategoryIconPath = (categorySlug: string): string => {
  const iconPaths: Record<string, string> = {
    ...
    'street-food': 'M12 2l-2 2H7l-1.5 2H4c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-1.5L17 4h-3l-2-2h-0zm0 4c2.5 0 4.5 2 4.5 4.5S14.5 15 12 15s-4.5-2-4.5-4.5S9.5 6 12 6zm0 2c-1.4 0-2.5 1.1-2.5 2.5S10.6 13 12 13s2.5-1.1 2.5-2.5S13.4 8 12 8zm-8 8h2v2H4v-2zm12 0h2v2h-2v-2zm4 0h2v2h-2v-2z', // Food cart/stand icon
    ...
    'waterfall': 'M12 2v6h2v2h-2v2h1v2h-1v2h3v2h-3v4h-2v-4H7v-2h3v-2h-1v-2h1v-2H8V8h2V2h2zm-1 14h2v2h-2v-2z', // Cascading waterfall
