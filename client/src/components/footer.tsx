      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <h4 className="text-2xl font-bold text-chili-red mb-4 font-questrial">ĐiĐiVui</h4>
            <p className="text-gray-300 mb-4 leading-relaxed">
              Your ultimate guide to Ninh Thuan's kitesurfing paradise and Vietnamese culture. 
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 ĐiĐiVui. All rights reserved. Built for the kitesurfing community in Ninh Thuan, Vietnam.</p>
        </div>
      </div>
    </footer>
  );
